          ...
          <div className={`bg-customWhite w-[33.25%] h-40 flex justify-center items-center relative transition-transform duration-[2000ms] md:w-full md:h-28 ${styles.contact_get_in_touch_card_one}`}>
            ...
            <div className={`text-center ${styles.contact_get_in_touch_card_front_side}`}>
             ...
             <div className={`bg-customWhite ${styles.contact_get_in_touch_card_back_side}`}>
              <Link href='mailto:robustrenovators@gmail.com' className={`text-lg transition-all duration-500 ease-out hover:text-customBlue lg:text-sm md:text-lg sm:text-base xxxs:text-sm ${mondaFont.className}`}>robustrenovators@gmail.com</Link>
             </div>
        ...
        <div className='w-full mx-auto'>
          ...
          <div className='flex flex-row justify-between xl:flex-col'>
            ...
            <div className='flex w-[33%] justify-center pr-20 xl:pr-0 xl:pt-10 xl:w-full'>
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3916.5554626777666!2d76.99646101088855!3d10.996888089120427!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba859c33bfdffe9%3A0xe433fb1074be9f97!2sLeo%20Ortho%20Care%20Hospital!5e0!3m2!1sen!2sin!4v1725442984041!5m2!1sen!2sin"
                className='w-[400px] h-[777px] xl:!w-full xl:h-[450px]' title="otdrivers Constructions Google Map Location" style={{ border: 0 }} allowFullScreen loading='lazy'></iframe>
            </div>
